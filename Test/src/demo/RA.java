...
public class RA {
	...
	public void Desinscribir_Random() {
		...
		if( listadoAsignaturasPostuladasAux.size() <= 0 ) {
			...
			int rand_int2 = rand2.nextInt(listadoAsignaturasPostuladasAux.size());
			// Se selecciona hace click a desinscribir
			driver.findElement(By.cssSelector("tr.nivel:nth-child("+ (rand_int2 + 1) +") > td:nth-child(7)")).click();
